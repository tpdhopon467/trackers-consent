...
function CheckboxGroup(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_FormGroup["default"], null, _mockdata.checkBoxs.map(function (item, index) {
    var checked = item.name === 'necessary' ? true : item.name === 'personalization' ? personalization : item.name === 'analytical' ? analytical : item.name === 'advertising' ? advertising : social;
